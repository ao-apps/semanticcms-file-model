...
[![Build](https://github.com/ao-apps/semanticcms-file-model/actions/workflows/build.yml/badge.svg?branch=1.x)](https://github.com/ao-apps/semanticcms-file-model/actions?query=workflow%3ABuild)
